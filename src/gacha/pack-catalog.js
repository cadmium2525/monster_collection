...
const PACK_DETAILS = Object.freeze({
  '機鋼': Object.freeze({ id: 'pack-inorganic', name: '機鋼の覚醒', sigil: '機', color: '#48d7f2', description: '機鋼モンスターと装甲戦術を中心に収録。' }),
  '神造': Object.freeze({ id: 'pack-creation', name: '神造の錬成', sigil: '神', color: '#f2c760', description: '神造モンスターと技巧的な支援を中心に収録。' }),
