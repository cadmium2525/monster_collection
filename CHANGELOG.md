...
- 現在のFirebase匿名UIDへメールアドレス／パスワードをリンクする復旧設定と、新端末での既存アカウント復旧、パスワード再設定メール送信を追加。
...
- `FIREBASE_SETUP.md`へEmail/Passwordプロバイダー、復旧手順、メールテンプレート、匿名アカウント自動クリーンアップの注意を追記。

### Verified

- 全202件の自動テストとv1.20.0 GitHub Pages/PWAビルド（254ファイル、24,171,025 bytes）が成功。
