...
const printable = process.argv.includes('--summary') ? {
  ...
  awakeningGameRate: result.awakeningGameRate,
  secondPlayerAwakeningRate: result.secondPlayerAwakeningRate,
  turn10AwakeningRate: result.turn10AwakeningRate,
  awakeningSameTurnWinRate: result.awakeningSameTurnWinRate,
  turn10AwakeningSameTurnWinRate: result.turn10AwakeningSameTurnWinRate,
  awakeningCounts: {
    games: result.gamesWithAwakening,
    secondPlayer: result.secondPlayerAwakenings,
    turn10: result.turn10Awakenings,
    sameTurnWins: result.awakeningTurnWins,
    turn10SameTurnWins: result.turn10AwakeningTurnWins,
  },
  awakeningAbilities: result.awakeningAbilities,
  decisiveAwakeningAbilities: result.decisiveAwakeningAbilities,
  decisiveAwakeningActions: result.decisiveAwakeningActions,
  sideA: {
